...
const BASE_CELL_BORDER_WIDTH: number = 1;
const BASE_CELL_BORDER_COLOR: string = "#ccc";
const BASE_CELL_MARGIN_H: number = 0;
const BASE_CELL_ALIGN_ITEMS: "center" | "flex-start" | "flex-end" =
  "center";
const BASE_CELL_JUSTIFY_CONTENT:
  | "center"
  | "flex-start"
  | "flex-end"
  | "space-between" = "center";

const CELL_STYLE: ViewStyle = {
...
const SLOT_POSITION: "absolute" | "relative" = "relative";
